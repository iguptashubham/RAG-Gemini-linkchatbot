...
class LLMChain:
    ...
    def vectordb(self,data=None,add=False):
    ...
    def prompts(self):
        prompt = PromptTemplate(
            template="You are a super advanced AI which has knowledge of everything. Generate info on the basis of the given context and also add your creativity and explain in simple language. Context: {context}\nQuestion: {question}\nAnswer:",
